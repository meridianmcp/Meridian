...
|---|---|---|---|
| Thesis-local research code | `C:\Users\13144\Documents\Masters_Thesis\CURRENT_PROJECT_CODE\helpers\*` | evidence/fixture only | must be extracted behind a typed `research_evidence` contract (R-1..R-3) before any Meridian product claim |
